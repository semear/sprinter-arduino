...
#define STRING_CONFIG_H_AUTHOR "Malalves - SEMEAR" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 OLAR EU FUNCIONO         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Sprinter-SEMEAR"
 ...
 */
#define TEMP_SENSOR_0 11 //precisa de testes, não sabemos a marca do thermistor
 ...
 */
 //calibrar E
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 39.062, 39.062, 39.062, 500 }
